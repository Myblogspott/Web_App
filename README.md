...
## Video demonstration and submission

For the required screen recording (candidate on camera, approach and prompts, architecture, LLM setup, UX, deployment, and documentation), use the script and checklist in [docs/VIDEO_DEMO_SCRIPT.md](docs/VIDEO_DEMO_SCRIPT.md). Submit the video plus your GitHub/GitLab repository link.
