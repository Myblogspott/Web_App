...
- [ ] Confirm API choice and complete Phase 1.
- [ ] Set up repo and base architecture (Phase 2).
- [ ] Implement MCP Server (Phase 3).
- [ ] Implement LLM Agent backend and tools (Phase 4).
- [ ] Build frontend UI (Phase 5).
- [ ] Integrate, test, and refine (Phase 6).
- [ ] Finalize documentation (Phase 7).
- [ ] Record and review the demo video (Phase 8).
